...
passport.use('local', new  LocalStrategy({usernameField: 'email', passReqToCallback : true}, (req, username, password, done) => {

    var email = username
    loginAttempt().finally(() => { console.log('Checking for', email)});
